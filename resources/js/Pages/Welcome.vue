<template>
    <div class="relative flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
        ...
        <div>
            <h1 class="text-5xl font-black" color="#EF3B2D" id="chickTitle">Chicken Run</h1>
        </div>
        <div>
            <div>
